"""
Exercise: 24 Caching Interning

Goal: Implement and practice 24_caching_interning
...
def example_function() -> str:
    """Example function for 24_caching_interning."""
    return "24_caching_interning implementation"
