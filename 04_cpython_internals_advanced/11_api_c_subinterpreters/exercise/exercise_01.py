"""
Exercise: 11 Api C Subinterpreters

Goal: Implement and practice 11_api_c_subinterpreters
...
def example_function() -> str:
    """Example function for 11_api_c_subinterpreters."""
    return "11_api_c_subinterpreters implementation"
