"""
Exercise: 22 Reference Counting

Goal: Implement and practice 22_reference_counting
...
def example_function() -> str:
    """Example function for 22_reference_counting."""
    return "22_reference_counting implementation"
