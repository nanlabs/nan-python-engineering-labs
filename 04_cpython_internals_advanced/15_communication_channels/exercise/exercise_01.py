"""
Exercise: 15 Communication Channels

Goal: Implement and practice 15_communication_channels
...
def example_function() -> str:
    """Example function for 15_communication_channels."""
    return "15_communication_channels implementation"
