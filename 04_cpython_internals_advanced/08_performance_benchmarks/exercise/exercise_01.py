"""
Exercise: 08 Performance Benchmarks

Goal: Implement and practice 08_performance_benchmarks
...
def example_function() -> str:
    """Example function for 08_performance_benchmarks."""
    return "08_performance_benchmarks implementation"
