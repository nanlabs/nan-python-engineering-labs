"""
Exercise: 21 Pyobject Structure

Goal: Implement and practice 21_pyobject_structure
...
def example_function() -> str:
    """Example function for 21_pyobject_structure."""
    return "21_pyobject_structure implementation"
