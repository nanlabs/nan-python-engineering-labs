...
**Regex Optional** is a fundamental Python concept that helps developers write code that is more expressive, maintainable, and efficient.
...
The philosophy behind Regex Optional aligns with the Zen of Python: "Simple is better than complex", "Explicit is better than implicit".
...
```python
# Working example of Regex Optional
...
Before adopting Regex Optional, developers often run into:
...
- [Python Docs: Regex Optional](https://docs.python.org/3/library/re.html)

## 5. Practice Task

### Basic Level ⭐
**Goal**: Implement basic usage of Regex Optional
