"""
Exercise: Text File Handling

Goal: Implement and practice text_file_handling
...
def example_function() -> str:
    """Example function for text_file_handling."""
    return "text_file_handling implementation"
