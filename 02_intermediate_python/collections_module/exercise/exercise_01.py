"""
Exercise: Collections Module

Goal: Implement and practice collections_module
...
def example_function() -> str:
    """Example function for collections_module."""
    return "collections_module implementation"
