...
**Init and Self** is a core object-oriented programming concept in Python that improves code organization, reuse, and maintainability.
...
```python
# Working example of Init and Self
...
### Basic Level ⭐
**Goal**: Implement basic usage of Init and Self
