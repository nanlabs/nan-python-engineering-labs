"""
Exercise: Attributes Methods

Goal: Implement and practice attributes_methods
...
def example_function() -> str:
    """Example function for attributes_methods."""
    return "attributes_methods implementation"
