"""
Exercise: 12 Keyless Signing Oidc

Goal: Implement and practice 12_keyless_signing_oidc
...
def example_function() -> str:
    """Example function for 12_keyless_signing_oidc."""
    return "12_keyless_signing_oidc implementation"
