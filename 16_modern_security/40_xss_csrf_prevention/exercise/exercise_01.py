"""
Exercise: 40 Xss Csrf Prevention

Goal: Implement and practice 40_xss_csrf_prevention
...
def example_function() -> str:
    """Example function for 40_xss_csrf_prevention."""
    return "40_xss_csrf_prevention implementation"
