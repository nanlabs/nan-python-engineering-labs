"""
Exercise: 38 Input Validation

Goal: Implement and practice 38_input_validation
...
def example_function() -> str:
    """Example function for 38_input_validation."""
    return "38_input_validation implementation"
