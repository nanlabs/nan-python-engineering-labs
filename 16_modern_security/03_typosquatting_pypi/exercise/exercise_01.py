"""
Exercise: 03 Typosquatting Pypi

Goal: Implement and practice 03_typosquatting_pypi
...
def example_function() -> str:
    """Example function for 03_typosquatting_pypi."""
    return "03_typosquatting_pypi implementation"
