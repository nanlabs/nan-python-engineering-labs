"""
Exercise: 14 Signing Containers

Goal: Implement and practice 14_signing_containers
...
def example_function() -> str:
    """Example function for 14_signing_containers."""
    return "14_signing_containers implementation"
