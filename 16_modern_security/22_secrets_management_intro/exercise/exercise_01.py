"""
Exercise: 22 Secrets Management Intro

Goal: Implement and practice 22_secrets_management_intro
...
def example_function() -> str:
    """Example function for 22_secrets_management_intro."""
    return "22_secrets_management_intro implementation"
