"""
Exercise: 13 Signing Wheels Cosign

Goal: Implement and practice 13_signing_wheels_cosign
...
def example_function() -> str:
    """Example function for 13_signing_wheels_cosign."""
    return "13_signing_wheels_cosign implementation"
