"""
Exercise: 18 Trivy Containers

Goal: Implement and practice 18_trivy_containers
...
def example_function() -> str:
    """Example function for 18_trivy_containers."""
    return "18_trivy_containers implementation"
