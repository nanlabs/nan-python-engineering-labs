"""
Exercise: 20 Dependabot Github

Goal: Implement and practice 20_dependabot_github
...
def example_function() -> str:
    """Example function for 20_dependabot_github."""
    return "20_dependabot_github implementation"
