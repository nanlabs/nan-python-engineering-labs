"""
Exercise: 29 Key Rotation Sops

Goal: Implement and practice 29_key_rotation_sops
...
def example_function() -> str:
    """Example function for 29_key_rotation_sops."""
    return "29_key_rotation_sops implementation"
