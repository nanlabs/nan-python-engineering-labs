"""
Exercise: 11 Sigstore Architecture

Goal: Implement and practice 11_sigstore_architecture
...
def example_function() -> str:
    """Example function for 11_sigstore_architecture."""
    return "11_sigstore_architecture implementation"
