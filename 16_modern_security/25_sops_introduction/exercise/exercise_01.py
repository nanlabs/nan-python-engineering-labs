"""
Exercise: 25 Sops Introduction

Goal: Implement and practice 25_sops_introduction
...
def example_function() -> str:
    """Example function for 25_sops_introduction."""
    return "25_sops_introduction implementation"
