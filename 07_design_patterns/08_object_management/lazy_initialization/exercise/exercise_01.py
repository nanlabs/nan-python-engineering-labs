"""
Exercise: Lazy Initialization

Goal: Implement and practice lazy_initialization
...
def example_function() -> str:
    """Example function for lazy_initialization."""
    return "lazy_initialization implementation"
