"""
Exercise: Backend For Frontend

Goal: Implement and practice backend_for_frontend
...
def example_function() -> str:
    """Example function for backend_for_frontend."""
    return "backend_for_frontend implementation"
