"""
Exercise: Thread Specific Storage

Goal: Implement and practice thread_specific_storage
...
def example_function() -> str:
    """Example function for thread_specific_storage."""
    return "thread_specific_storage implementation"
