"""
Exercise: Double Checked Locking

Goal: Implement and practice double_checked_locking
...
def example_function() -> str:
    """Example function for double_checked_locking."""
    return "double_checked_locking implementation"
