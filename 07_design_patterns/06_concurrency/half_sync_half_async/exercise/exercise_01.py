"""
Exercise: Half Sync Half Async

Goal: Implement and practice half_sync_half_async
...
def example_function() -> str:
    """Example function for half_sync_half_async."""
    return "half_sync_half_async implementation"
