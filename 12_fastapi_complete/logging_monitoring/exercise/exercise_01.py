"""
Exercise: Logging Monitoring

Goal: Implement and practice logging_monitoring
...
def example_function() -> str:
    """Example function for logging_monitoring."""
    return "logging_monitoring implementation"
