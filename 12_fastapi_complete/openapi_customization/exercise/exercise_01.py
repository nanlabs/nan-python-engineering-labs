"""
Exercise: Openapi Customization

Goal: Implement and practice openapi_customization
...
def example_function() -> str:
    """Example function for openapi_customization."""
    return "openapi_customization implementation"
