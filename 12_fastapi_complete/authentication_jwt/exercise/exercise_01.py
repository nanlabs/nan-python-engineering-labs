"""
Exercise: Authentication Jwt

Goal: Implement and practice authentication_jwt
...
def example_function() -> str:
    """Example function for authentication_jwt."""
    return "authentication_jwt implementation"
