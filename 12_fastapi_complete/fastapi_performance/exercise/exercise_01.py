"""
Exercise: Fastapi Performance

Goal: Implement and practice fastapi_performance
...
def example_function() -> str:
    """Example function for fastapi_performance."""
    return "fastapi_performance implementation"
