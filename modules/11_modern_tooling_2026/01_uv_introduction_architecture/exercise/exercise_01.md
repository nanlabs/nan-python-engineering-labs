...
1. Check the cache location:

   ```bash
   uv cache dir
   ```

1. Explore cache contents (if present):
...
1. Compare timings. How much faster is uv?
...
1. Check the output of the second installation. Was it instant?
...
01. Experiment with dependency conflicts:
...
01. Compare uv vs pip error messages. Which one is clearer?

## Reflection Questions

1. Why is uv faster than pip?
1. What benefits does the global cache provide?
1. In which scenarios is uv most beneficial?
1. What drawbacks or risks can you identify?
