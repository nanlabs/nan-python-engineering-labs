...
def get_python_docs_for_topic(topic_name: str) -> dict:
    ...
    mappings = {
        ...
        "dataclass": {"url": f"{base}library/dataclasses.html", "module": "dataclasses", "pep": "557"},
        ...
        "protocol": {"url": f"{base}library/typing.html#typing.Protocol", "module": "typing", "pep": "544"},
        "typeddict": {"url": f"{base}library/typing.html#typing.TypedDict", "module": "typing", "pep": "589"},
        ...
        "await": {"url": f"{base}reference/expressions.html#await", "module": "asyncio", "pep": "492"},
        
        # Concurrency
        "threading": {"url": f"{base}library/threading.html", "module": "threading"},
        "multiprocessing": {"url": f"{base}library/multiprocessing.html", "module": "multiprocessing"},
        "concurrent": {"url": f"{base}library/concurrent.futures.html", "module": "concurrent.futures"},
        ...
        # Context managers
        "context": {"url": f"{base}reference/datamodel.html#context-managers", "module": "contextlib"},
