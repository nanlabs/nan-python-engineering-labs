...
- [SBOM Formats Comparison](https://www.aquasec.com/cloud-native-academy/supply-chain-security/sbom/)"""
    ...
    # Sigstore / Signing
    elif "sigstore" in topic_lower or "signing" in topic_lower or "firmar" in topic_lower or "cosign" in topic_lower or "rekor" in topic_lower or "verificacion" in topic_lower:
...
- [Vault on Kubernetes](https://www.hashicorp.com/blog/injecting-vault-secrets-into-kubernetes-pods-via-a-sidecar)"""
    ...
    elif "vulnerability" in topic_lower or "scanning" in topic_lower or "trivy" in topic_lower or "grype" in topic_lower or "safety" in topic_lower:
...
- [Scanning Python Dependencies](https://realpython.com/python-security-scanner/)"""
    ...
    # Kubernetes Secrets
    elif "kubernetes" in topic_lower or "k8s" in topic_lower or "sealed" in topic_lower or "external_secret" in topic_lower:
...
- [Vulnerability Patching Strategy](https://snyk.io/blog/best-practices-for-dependency-management/)"""
    ...
    elif "input" in topic_lower or "sql" in topic_lower or "xss" in topic_lower or "csrf" in topic_lower or "injection" in topic_lower:
