"""
Exercise: Coroutines Async Await

Goal: Implement and practice coroutines_async_await
...
def example_function() -> str:
    """Example function for coroutines_async_await."""
    return "coroutines_async_await implementation"
