"""
Exercise: Event Loop Internals

Goal: Implement and practice event_loop_internals
...
def example_function() -> str:
    """Example function for event_loop_internals."""
    return "event_loop_internals implementation"
