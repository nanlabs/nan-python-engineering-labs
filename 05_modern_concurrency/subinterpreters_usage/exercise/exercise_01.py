"""
Exercise: Subinterpreters Usage

Goal: Implement and practice subinterpreters_usage
...
def example_function() -> str:
    """Example function for subinterpreters_usage."""
    return "subinterpreters_usage implementation"
