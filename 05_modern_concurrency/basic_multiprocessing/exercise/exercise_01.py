"""
Exercise: Basic Multiprocessing

Goal: Implement and practice basic_multiprocessing
...
def example_function() -> str:
    """Example function for basic_multiprocessing."""
    return "basic_multiprocessing implementation"
