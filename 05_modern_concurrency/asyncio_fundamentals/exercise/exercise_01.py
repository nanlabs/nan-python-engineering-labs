"""
Exercise: Asyncio Fundamentals

Goal: Implement and practice asyncio_fundamentals
...
def example_function() -> str:
    """Example function for asyncio_fundamentals."""
    return "asyncio_fundamentals implementation"
