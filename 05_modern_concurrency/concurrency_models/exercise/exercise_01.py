"""
Exercise: Concurrency Models

Goal: Implement and practice concurrency_models
...
def example_function() -> str:
    """Example function for concurrency_models."""
    return "concurrency_models implementation"
