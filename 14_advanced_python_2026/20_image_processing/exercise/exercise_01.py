"""
Exercise: 20 Image Processing

Goal: Implement and practice 20_image_processing
...
def example_function() -> str:
    """Example function for 20_image_processing."""
    return "20_image_processing implementation"
