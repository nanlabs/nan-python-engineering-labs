"""
Exercise: 05 Error Handling Pyresult

Goal: Implement and practice 05_error_handling_pyresult
...
def example_function() -> str:
    """Example function for 05_error_handling_pyresult."""
    return "05_error_handling_pyresult implementation"
