"""
Exercise: 27 Function Calling Tools

Goal: Implement and practice 27_function_calling_tools
...
def example_function() -> str:
    """Example function for 27_function_calling_tools."""
    return "27_function_calling_tools implementation"
