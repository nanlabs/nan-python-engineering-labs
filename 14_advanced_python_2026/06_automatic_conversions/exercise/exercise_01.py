"""
Exercise: 06 Automatic Conversions

Goal: Implement and practice 06_automatic_conversions
...
def example_function() -> str:
    """Example function for 06_automatic_conversions."""
    return "06_automatic_conversions implementation"
