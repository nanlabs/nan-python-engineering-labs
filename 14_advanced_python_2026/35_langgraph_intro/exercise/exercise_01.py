"""
Exercise: 35 Langgraph Intro

Goal: Implement and practice 35_langgraph_intro
...
def example_function() -> str:
    """Example function for 35_langgraph_intro."""
    return "35_langgraph_intro implementation"
