"""
Exercise: 42 Agent Executors

Goal: Implement and practice 42_agent_executors
...
def example_function() -> str:
    """Example function for 42_agent_executors."""
    return "42_agent_executors implementation"
