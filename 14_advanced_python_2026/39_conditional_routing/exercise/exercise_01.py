"""
Exercise: 39 Conditional Routing

Goal: Implement and practice 39_conditional_routing
...
def example_function() -> str:
    """Example function for 39_conditional_routing."""
    return "39_conditional_routing implementation"
