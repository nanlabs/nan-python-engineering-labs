"""
Exercise: 04 Python Types In Rust

Goal: Implement and practice 04_python_types_in_rust
...
def example_function() -> str:
    """Example function for 04_python_types_in_rust."""
    return "04_python_types_in_rust implementation"
