"""
Exercise: 09 Properties Rust

Goal: Implement and practice 09_properties_rust
...
def example_function() -> str:
    """Example function for 09_properties_rust."""
    return "09_properties_rust implementation"
