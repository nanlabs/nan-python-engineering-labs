"""
Exercise: 38 State Management

Goal: Implement and practice 38_state_management
...
def example_function() -> str:
    """Example function for 38_state_management."""
    return "38_state_management implementation"
