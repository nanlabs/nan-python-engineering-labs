"""
Exercise: 21 Cryptography Hashing

Goal: Implement and practice 21_cryptography_hashing
...
def example_function() -> str:
    """Example function for 21_cryptography_hashing."""
    return "21_cryptography_hashing implementation"
