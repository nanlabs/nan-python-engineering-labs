"""
Exercise: 26 Code Prompt Engineering

Goal: Implement and practice 26_code_prompt_engineering
...
def example_function() -> str:
    """Example function for 26_code_prompt_engineering."""
    return "26_code_prompt_engineering implementation"
