"""
Exercise: 29 Langchain Chains

Goal: Implement and practice 29_langchain_chains
...
def example_function() -> str:
    """Example function for 29_langchain_chains."""
    return "29_langchain_chains implementation"
