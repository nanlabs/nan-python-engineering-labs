"""
Exercise: 15 Async Rust Pyo3

Goal: Implement and practice 15_async_rust_pyo3
...
def example_function() -> str:
    """Example function for 15_async_rust_pyo3."""
    return "15_async_rust_pyo3 implementation"
