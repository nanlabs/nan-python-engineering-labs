"""
Exercise: 14 Shared Mutable State

Goal: Implement and practice 14_shared_mutable_state
...
def example_function() -> str:
    """Example function for 14_shared_mutable_state."""
    return "14_shared_mutable_state implementation"
