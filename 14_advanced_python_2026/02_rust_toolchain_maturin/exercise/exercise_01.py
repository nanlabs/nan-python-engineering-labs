"""
Exercise: 02 Rust Toolchain Maturin

Goal: Implement and practice 02_rust_toolchain_maturin
...
def example_function() -> str:
    """Example function for 02_rust_toolchain_maturin."""
    return "02_rust_toolchain_maturin implementation"
