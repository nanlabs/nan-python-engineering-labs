"""
Exercise: 21 Type Checkers Comparison

Goal: Implement and practice 21_type_checkers_comparison
...
def example_function() -> str:
    """Example function for 21_type_checkers_comparison."""
    return "21_type_checkers_comparison implementation"
