...
1. [uv: installation and initial configuration](02_uv_installation_configuration/)
1. [uv pip: ultra-fast package installation](03_uv_pip_package_installation/)
1. [uv venv: Virtual environment management](04_uv_venv_virtual_environments/)
1. [uv tool: Global tools](05_uv_tool_global_tools/)
1. [uv in pyproject.toml](06_uv_pyproject_toml/)
1. [Lock files with uv (uv.lock)](07_uv_lock_files/)
1. [Workspaces and monorepos with uv](08_uv_workspaces_monorepos/)
1. [Scripts and entry points](09_uv_scripts_entry_points/)

### Group 2: Ruff - Ultra-Fast Linter and Formatter (8 topics)

10. [Ruff: Introduction and speed](10_ruff_introduction_speed/)
01. [Ruff as linter: available rules](11_ruff_linter_rules/)
01. [Ruff as formatter (Black replacement)](12_ruff_formatter_black/)
01. [Ruff as import sorter (isort replacement)](13_ruff_import_sorter_isort/)
01. [Configuration in pyproject.toml](14_ruff_pyproject_configuration/)
01. [Strict rules for production code](15_ruff_strict_rules/)
01. [Performance benchmarks](16_ruff_performance_benchmarks/)
01. [Workflow integration (pre-commit, CI/CD)](17_ruff_workflow_integration/)

### Group 3: Modern Type Checkers (6 topics)

18. [mypy: Current state in 2026](18_mypy_current_state_2026/)
01. [Pyright and BasedPyright](19_pyright_basedpyright/)
01. [Pylyzer: Type checker in Rust](20_pylyzer_type_checker_rust/)
01. [Comparison: mypy vs pyright vs pylyzer](21_type_checkers_comparison/)
01. [Strict typing configuration](22_strict_typing_configuration/)
01. [Type narrowing and advanced type guards](23_type_narrowing_advanced_guards/)

### Group 4: Pre-commit and Hooks (3 topics)

24. [Pre-commit: Configuration and essential hooks](24_precommit_configuration_hooks/)
01. [Security hooks: detect-secrets and bandit](25_precommit_security_hooks/)
01. [Hook performance and caching](26_precommit_performance_caching/)

### Group 5: Modern Testing (5 topics)

27. [Advanced pytest: fixtures and parametrize](27_pytest_advanced_fixtures/)
01. [pytest-cov and coverage analysis](28_pytest_cov_coverage/)
01. [pytest-xdist: test parallelization](29_pytest_xdist_parallelization/)
01. [Hypothesis: property-based testing](30_hypothesis_property_testing/)
01. [Mutation testing with mutmut](31_mutation_testing_mutmut/)

### Group 6: Modern Debugging and Profiling (4 topics)

32. [py-spy: profiling without overhead](32_pyspy_profiling_without_overhead/)
01. [memray: modern memory profiling](33_memray_memory_profiling/)
01. [viztracer: visual tracing](34_viztracer_tracing_visual/)
01. [debugpy and remote debugging](35_debugpy_remote_debugging/)
