"""
Exercise: 12 Ruff Formatter Black

Goal: Implement and practice 12_ruff_formatter_black
...
def example_function() -> str:
    """Example function for 12_ruff_formatter_black."""
    return "12_ruff_formatter_black implementation"
