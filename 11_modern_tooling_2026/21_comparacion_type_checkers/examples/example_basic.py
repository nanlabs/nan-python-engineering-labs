...
def feature_matrix() -> list[dict[str, object]]:
    return [
        ...
        {"tool": "pyright",       "language": "Python", "speed": "fast",   "strict": True,  "plugins": False},
        {"tool": "basedpyright",  "language": "Python", "speed": "fast",   "strict": True,  "plugins": False},
        {"tool": "pylyzer",       "language": "Rust",   "speed": "fastest","strict": True,  "plugins": False},
    ]
...
def main() -> None:
    ...
    for row in matrix:
        print(f"  {row['tool']:<15} {row['speed']:<10} {str(row['strict']):>8}")
