"""
Exercise: 05 Uv Tool Global Tools

Goal: Implement and practice 05_uv_tool_global_tools
...
def example_function() -> str:
    """Example function for 05_uv_tool_global_tools."""
    return "05_uv_tool_global_tools implementation"
