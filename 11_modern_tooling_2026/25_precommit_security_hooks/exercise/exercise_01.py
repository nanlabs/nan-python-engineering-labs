"""
Exercise: 25 Precommit Security Hooks

Goal: Implement and practice 25_precommit_security_hooks
...
def example_function() -> str:
    """Example function for 25_precommit_security_hooks."""
    return "25_precommit_security_hooks implementation"
