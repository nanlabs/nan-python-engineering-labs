"""
Exercise: Profiling Cprofile

Goal: Implement and practice profiling_cprofile
...
def example_function() -> str:
    """Example function for profiling_cprofile."""
    return "profiling_cprofile implementation"
