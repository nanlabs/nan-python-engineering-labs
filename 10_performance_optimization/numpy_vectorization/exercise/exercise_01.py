"""
Exercise: Numpy Vectorization

Goal: Implement and practice numpy_vectorization
...
def example_function() -> str:
    """Example function for numpy_vectorization."""
    return "numpy_vectorization implementation"
